...
echo $(date -u) "#                                                                                                                                   #" | tee -a  ~/Installation.log
echo $(date -u) "# V2.3.9 (Rev a), 09.01.2021 - Unterstützt NVIDIA Jetson NANO und NVIDIA Jetson Xavier NX, Beta für AGX mit JP 4.4.1                #" | tee -a  ~/Installation.log
echo $(date -u) "#####################################################################################################################################" | tee -a  ~/Installation.log
echo $(date -u) "....................................................................................................................................." | tee -a  ~/Installation.log
...
echo $(date -u) "....................................................................................................................................." | tee -a  ~/Installation.log
                 ...
                 sudo swapon --show | tee -a  ~/Installation.log
...
echo $(date -u) "....................................................................................................................................." | tee -a  ~/Installation.log
                 ...
                 echo 'source /home/nvidia/.local/bin/virtualenvwrapper.sh' >>~/.bashrc
...
echo $(date -u) "....................................................................................................................................." | tee -a  ~/Installation.log
                 ...
                 python3 -m pip install pip testresources setuptools==49.6.0
                 python3 -m pip install numpy==1.16.1 future==0.18.2 mock==3.0.5 h5py==2.10.0 keras_preprocessing==1.1.1 keras_applications==1.0.8 gast==0.3.3 futures protobuf pybind11
                 sudo apt -y install cython3
                 sudo apt -y install python3-matplotlib
                 python3 -m pip install --ignore-installed pycocotools==2.0.2
                 python3 -m pip install scipy==1.4.1
                 python3 -m pip install keras==2.3.1
                 python3 -m pip install grpcio absl-py==0.9.0 py-cpuinfo==5.0.0 psutil==5.7.0 portpicker==1.3.1 six==1.14.0 requests==2.23.0
                 python3 -m pip install astor==0.8.1 termcolor==1.1.0 wrapt==1.12.1 google-pasta==0.2.0
                 ...
                 if [ $TensorFlow = "1" ]
                 then
                          python3 -m pip --pre --extra-index-url https://developer.download.nvidia.com/compute/redist/jp/v44 'tensorflow<2'
                 else
                          python3 -m pip --pre --extra-index-url https://developer.download.nvidia.com/compute/redist/jp/v44 tensorflow
                 fi
...
echo $(date -u) "....................................................................................................................................." | tee -a  ~/Installation.log
                 ...
                 python3 -m pip matplotlib==3.2.1 scikit-learn
                 sudo apt -y install python3-tk
                 python3 -m pip pillow==7.1.2 imutils==0.5.3 
