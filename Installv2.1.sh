...
echo "1 von 24: : SUDO - rechte um ohne Passworteingabe zukünftig installieren zu können" >> ~/Installation.log
#sudo cp /etc/sudoers /etc/sudoers.bak
#sudo echo 'nvidia ALL=(ALL) NOPASSWD:ALL' >> /etc/sudoers

echo "2 von 24: Systemupdate" >> ~/Installation.log
sudo apt -y update
sudo apt -y upgrade
sudo ldconfig
...
echo "3 von 24: Upgrade inkl. Firmware update (falls erforderlich)"  >> ~/Installation.log
sudo apt -y dist-upgrade

echo "4 von 24: Swap-File anlegen  4GB, aktivieren und kontrollieren" >> ~/Installation.log
...
echo "5 von 24: Systemwerkzeuge, Editor, Tools" >> ~/Installation.log
sudo apt -y install git-all
sudo apt -y install libatlas-base-dev gfortran
sudo apt -y install libhdf5-serial-dev hdf5-tools
sudo apt -y install python3-dev locate

echo "6 von 24: Pakete für SciPy" >> ~/Installation.log
...
echo "7 von 24: XML Tool für Tensorflow API Objekterkennung" >> ~/Installation.log
sudo apt -y install libxml2-dev libxslt1-dev

echo "8 von 24: Pakete für OpenCV incl. Codecs, Image und GUI Bibliotheken" >> ~/Installation.log
...
echo "9 von 24: Pakete für die (USB) Kamera" >> ~/Installation.log
sudo apt -y install libv4l-dev libdc1394-22-dev v4l-utils

echo "10 von 24: PreCompiler: cmake" >> ~/Installation.log
...
sudo apt -y autoremove
echo "11.1 von 24: Pfadprüfung - Pfad ist gesetzt auf:" >> ~/Installation.log
echo $PATH >> ~/Installation.log

echo "11 von 24: Pythonpakete und Tools" >> ~/Installation.log
wget https://bootstrap.pypa.io/get-pip.py
sudo python3 get-pip.py
rm get-pip.py

echo "12 von 24: Virtuelle Umgebung installieren, anpassen und aktivieren" >> ~/Installation.log
sudo pip install virtualenv virtualenvwrapper
echo '#virtualenv and virtualenvwrapper' >> ~/.bashrc
echo 'export WORKON_HOME=$HOME/.virtualenvs' >> ~/.bashrc
echo 'export VIRTUALENVWRAPPER_PYTHON=/usr/bin/python3' >> ~/.bashrc
echo 'source /usr/local/bin/virtualenvwrapper.sh' >> ~/.bashrc
echo "12.1 von 24: Environmentprüfung - gesetzt auf:" >> ~/Installation.log
echo $WORKON_HOME >> ~/Installation.log
echo $VIRTUALENVWRAPPER_PYTHON >> ~/Installation.log

echo "13 von 24: Virtuelle Umgebung bauen" >> ~/Installation.log
...
echo "13.1 von 24: Erledigt. Neuer workspace für Installation ist:" >> ~/Installation.log
pwd >> Installation.log

echo "14 von 24: Protobuf installieren" >> ~/Installation.log
...
echo "15 von 24: Tensorflow+Keras, NumPy/SciPy installieren" >> ~/Installation.log
pip install numpy
pip install cython
...
echo "16 von 24: Installieren der Objekterkennung für TF" >> ~/Installation.log
cd ~
...
echo "17 von 24: Installation von NVIDIA vor-trainierten Modelle für TensorFlow / TensorRT" >> ~/Installation.log
cd ~
git clone --recursive https://github.com/NVIDIA-Jetson/tf_trt_models.git
cd tf_trt_models
./install.sh

echo "18 von 24: OpenCV herunterladen, compilieren und installieren" >> ~/Installation.log
cd ~
...
echo "19 von 24: OpenCV herunterladen, compilieren und installieren" >> ~/Installation.log
...
echo "19 von 24: OpenCV Symbolic-Link setzen " >> ~/Installation.log
...
echo "20 von 24: Weitere Bibliotheken installieren (nice2have)" >> ~/Installation.log
cd ~
pip install matplotlib scikit-learn
pip install pillow imutils scikit-image

echo "21 von 24: Installation von dlib und facerecognition" >> ~/Installation.log
cd ~
...
echo "22 von 24: Kleiner WEBServer und Jupyter Notebook machen die Arbeit einfacher" >> ~/Installation.log
pip install flask jupyter

echo "23 von 24: XML-Tool und Fortschrittsanzeige" >> ~/Installation.log
pip install lxml progressbar2

#echo "SUDO - Rechte zurücksetzen um ohne Passworteingabe installieren zu können"
#sudo cp /etc/sudoers.bak /etc/sudoers

echo "24 von 24: Aufräumen" >> ~/Installation.log
sudo apt -y autoremove
sudo apt -y clean

echo "25 von 24: SwapFile auf 1.5GB pro Kern setzen" >> ~/Installation.log
