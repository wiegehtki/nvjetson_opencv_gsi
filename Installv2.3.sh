...
echo "1 von 26: SUDO - rechte um ohne Passworteingabe zukünftig installieren zu können als root durchgeführt?" >> ~/Installation.log
...
export PATH=/home/nvidia/cmake-3.17.0/bin/:/home/nvidia/.local/bin/:$PATH
...
echo "13.1 von 26: Erledigt. PWD für Installation ist:" >> ~/Installation.log
echo $PWD >> ~/Installation.log
echo "13.2 von 26: Erledigt. Neuer workspace für Installation ist:" >> ~/Installation.log
